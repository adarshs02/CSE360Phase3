...
public class OpenMainUI {
	...
	private static Scene patientPortalUI;
	private static Scene nursePortalUI;
	private static Scene doctorPortalUI;
	private static Scene messagesUI;
	private static Scene contactInfoUI;
	private static Scene immunizaUI;
	private static Scene pastMedUI;
	private static Scene nurseQsUI;
	private static Scene visitsUI;
	
	
	public static Scene openMessages(Scene returnScreen) {
		//create pane
	...
	public static Scene openContactInfo(Scene returnScreen) {
		//create pane
	...
	public static Scene openImmunizations(Scene returnScreen) {
		//create pane
	...
	public static Scene openPastMed(Scene returnScreen) {
		//create pane
	...
	public static Scene openPatPort() {
		//create pane
		...
		messagesButton.setOnAction(e ->{
			mainUIstage.setScene(openMessages(patientPortalUI));
		});
		//add contact info button functionality
		contactInfoButton.setOnAction(e ->{
			mainUIstage.setScene(openContactInfo(patientPortalUI));
		});
		//add immunizations button functionality
		immunButton.setOnAction(e ->{
			mainUIstage.setScene(openImmunizations(patientPortalUI));
		});
		//add past medication button functionality
		pastMedButton.setOnAction(e ->{
			mainUIstage.setScene(openPastMed(patientPortalUI));
		});
		
		return patientPortalUI;
	}
	
	public static Scene openNurseQs(Scene returnScreen) {
		//create pane
	...
	public static Scene openNursePort() {
		//create pane
		...
		messagesButton.setOnAction(e ->{
			mainUIstage.setScene(openMessages(nursePortalUI));
		});	
		//add submit questions button functionality
		submitQsButton.setOnAction(e ->{
			mainUIstage.setScene(openNurseQs(nursePortalUI));
		});
		//add logout button functionality
		logoutButton.setOnAction(e ->{
			mainUIstage.setScene(mainUI);
	...
	public static Scene openVisits(Scene returnScreen) {
		//create pane
	...
	public static Scene openDocView() {
		//create pane
		...
		//add Messages button functionality
		messagesButton.setOnAction(e ->{
			mainUIstage.setScene(openMessages(doctorPortalUI));
		});	
		//add submit questions button functionality
		visitsButton.setOnAction(e ->{
			mainUIstage.setScene(openVisits(doctorPortalUI));
		});
